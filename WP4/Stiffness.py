...
stringer_top_num = np.array([7, 7, 3, 3]) #nummber of stringer at the top per interval (that's why it's a list) in np.array([...])
stringer_bottom_num = np.array([7, 7, 3, 3])  #nummber of stringer at the bottom per interval (that's why it's a list) in np.array([...])
