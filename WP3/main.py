...
while Running == True:
    ...
    iteration_data.append({
        ...
        "Weight wing [kg]": W_wing,
        "Weight horizontal tail [kg]": W_htail,
        "Weight vertical tail[kg]": W_vtail, 
        "Weight fuselage [kg]": W_fuse, 
        "Weight main landing gear [kg]": W_mLG, 
        "Weight nose landing gear [kg]": W_nLG, 
        "Weigth installed engine [kg]": W_eng, 
        "Weight fuel system [kg]": W_fs,
        "Weight fuel [kg]": W_fuel, 
        "Weight flight controls [kg]": W_fc,
        "Weight hydraulics [kg]": W_hyd,
        "Weight electrics [kg]": W_elec,
        "Weight avionics [kg]": W_avi,
        "Weight aircon [kg]": W_aircon,
        "Weight furnishing [kg]": W_furn,
        "Total weight [kg]": MTOW,
        "C_D fuselage": CD_0_Fus,
        "C_D wing": CD_0_Wing,
