...
def fuel_volume(root_chord, taper, span, m_fuel):
    ...
    distance_tank2 = span/2 *end_fuel_tank - span/2 *Landing_gear_end 
    ...
    Thickness_LE_beginning = 2*chord_beginning *(t_over_c/0.2)*(0.2969*math.sqrt(LE_pos)-0.126*LE_pos-0.3516*LE_pos**2 + 0.2843*LE_pos**3 - 0.1015*LE_pos**4)
    Thickness_TE_beginning = 2*chord_beginning *(t_over_c/0.2)*(0.2969*math.sqrt(TE_pos)-0.126*TE_pos-0.3516*TE_pos**2 + 0.2843*TE_pos**3 - 0.1015*TE_pos**4)
    ...
    Thickness_LE_LG_beginning = 2*chord_landing_gear_beginning *(t_over_c/0.2)*(0.2969*math.sqrt(LE_pos)-0.126*LE_pos-0.3516*LE_pos**2 + 0.2843*LE_pos**3 - 0.1015*LE_pos**4)
    Thickness_TE_LG_beginning = 2*chord_landing_gear_beginning *(t_over_c/0.2)*(0.2969*math.sqrt(TE_pos)-0.126*TE_pos-0.3516*TE_pos**2 + 0.2843*TE_pos**3 - 0.1015*TE_pos**4)
    ...
    print("VOlume tank 1:", Volume_tank1)

    Thickness_LE_LG_end = 2*chord_landing_gear_end *(t_over_c/0.2)*(0.2969*math.sqrt(LE_pos)-0.126*LE_pos-0.3516*LE_pos**2 + 0.2843*LE_pos**3 - 0.1015*LE_pos**4)
    Thickness_TE_LG_end = 2*chord_landing_gear_end *(t_over_c/0.2)*(0.2969*math.sqrt(TE_pos)-0.126*TE_pos-0.3516*TE_pos**2 + 0.2843*TE_pos**3 - 0.1015*TE_pos**4)
    ...
    Thickness_LE_end = 2*chord_end *(t_over_c/0.2)*(0.2969*math.sqrt(LE_pos)-0.126*LE_pos-0.3516*LE_pos**2 + 0.2843*LE_pos**3 - 0.1015*LE_pos**4)
    Thickness_TE_end = 2*chord_end *(t_over_c/0.2)*(0.2969*math.sqrt(TE_pos)-0.126*TE_pos-0.3516*TE_pos**2 + 0.2843*TE_pos**3 - 0.1015*TE_pos**4)
