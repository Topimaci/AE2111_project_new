...
def engine_required(thrust_required):
    ...
    engines = [
    ["Honeywell HTF7500E",            33486, 687,   916,     1.116, 2.282, 0.9128, 4.2, 16.9],
    ["Honeywell HTF7350 turbofans",   32574, 696,   928,     1.156, 2.281, 0.9124, 4.2, 16.9],
    ["Honeywell HTF7700L",            34100, 696,   928,     1.156, 2.282, 0.9128, 4.2, 16.9],
    ["Pratt & Whitney Canada PW305A", 23200, 452.5, 603.333, 1.147, 2.06,  0.824,  4.5, 16.9],
    ["Honeywell HTF7250G",            33900, 696,   928,     1.156, 2.281, 0.9124, 4.2, 16.9]
]   
